...
const tests = [
  ...
  // ══════════════════════════════════════════════════════════════════════════
  // MICROSOFT OFFICE (50 test cases)
  // ══════════════════════════════════════════════════════════════════════════
  { query: 'ms office open nahi ho rha hai', expectKB: true, expectIntent: 'incident' },
  { query: 'MS OFFICE OPEN NAHI HO RHA HAI', expectKB: true, expectIntent: 'incident' },
  { query: 'ms office 365 open nahi ho rha', expectKB: true, expectIntent: 'incident' },
  { query: 'MS OFFICE 365 OPEN NAHI HO RHA HAI', expectKB: true, expectIntent: 'incident' },
  { query: 'microsoft office open nahi ho rha', expectKB: true, expectIntent: 'incident' },
  { query: 'office 365 nahi chal rha', expectKB: true, expectIntent: 'incident' },
  { query: 'excel open nahi ho rha', expectKB: true, expectIntent: 'incident' },
  { query: 'EXCEL OPEN NAHI HO RHA HAI', expectKB: true, expectIntent: 'incident' },
  { query: 'word open nahi ho rha', expectKB: true, expectIntent: 'incident' },
  { query: 'WORD FILE OPEN NAHI HO RHA HAI', expectKB: true, expectIntent: 'incident' },
  { query: 'powerpoint open nahi ho rha', expectKB: true, expectIntent: 'incident' },
  { query: 'xlsx file open nahi ho rha', expectKB: true, expectIntent: 'incident' },
  { query: 'XLSX FILE OPEN NAHI HO RHA', expectKB: true, expectIntent: 'incident' },
  { query: 'docx file open nahi ho rha', expectKB: true, expectIntent: 'incident' },
  { query: 'DOCX FILE OPEN NAHI HO RHA HAI', expectKB: true, expectIntent: 'incident' },
  { query: 'excel crash ho rha hai', expectKB: true, expectIntent: 'incident' },
  { query: 'word crash ho rha hai', expectKB: true, expectIntent: 'incident' },
  { query: 'ms office crash ho rha', expectKB: true, expectIntent: 'incident' },
  { query: 'excel hang ho rha hai', expectKB: true, expectIntent: 'incident' },
  { query: 'word hang ho gaya', expectKB: true, expectIntent: 'incident' },
  { query: 'office file nahi khul rhi', expectKB: true, expectIntent: 'incident' },
  { query: 'excel nahi khul rha', expectKB: true, expectIntent: 'incident' },
  { query: 'word nahi khul rha', expectKB: true, expectIntent: 'incident' },
  { query: 'office 365 issue hai', expectKB: true, expectIntent: 'incident' },
  { query: 'ms excel kaam nahi kar rha', expectKB: true, expectIntent: 'incident' },
  { query: 'ms word kaam nahi kar rha', expectKB: true, expectIntent: 'incident' },
  { query: 'powerpoint crash', expectKB: true, expectIntent: 'incident' },
  { query: 'ppt open nahi ho rha', expectKB: true, expectIntent: 'incident' },
  { query: 'excel file nahi khul rhi', expectKB: true, expectIntent: 'incident' },
  { query: 'word file open nahi ho rhi', expectKB: true, expectIntent: 'incident' },
  { query: 'microsoft word crash ho rha', expectKB: true, expectIntent: 'incident' },
  { query: 'microsoft excel not working', expectKB: true, expectIntent: 'incident' },
  { query: 'MS WORD NOT OPENING', expectKB: true, expectIntent: 'incident' },
  { query: 'EXCEL NOT OPENING', expectKB: true, expectIntent: 'incident' },
  { query: 'office app nahi khul rhi', expectKB: true, expectIntent: 'incident' },
  { query: 'excel freeze ho gaya', expectKB: true, expectIntent: 'incident' },
  { query: 'word freeze ho gaya', expectKB: true, expectIntent: 'incident' },
  { query: 'ms office loading mein atak gaya', expectKB: true, expectIntent: 'incident' },
  { query: 'excel loading stuck hai', expectKB: true, expectIntent: 'incident' },
  { query: 'word document save nahi ho rha', expectKB: true, expectIntent: 'incident' },
  { query: 'excel sheet save nahi ho rhi', expectKB: false, expectIntent: 'incident' },
  { query: 'office 365 activate nahi ho rha', expectKB: true, expectIntent: 'incident' },
  { query: 'ms office activation issue', expectKB: true, expectIntent: 'incident' },
  { query: 'excel me error aa rha hai', expectKB: true, expectIntent: 'incident' },
  { query: 'word me error aa rha hai', expectKB: true, expectIntent: 'incident' },
  { query: 'office start nahi ho rha', expectKB: true, expectIntent: 'incident' },
  { query: 'excel band ho gaya', expectKB: true, expectIntent: 'incident' },
  { query: 'word band ho gaya', expectKB: true, expectIntent: 'incident' },
  { query: 'ms office response nahi de rha', expectKB: true, expectIntent: 'incident' },
  { query: 'excel hag ho rha hai', expectKB: true, expectIntent: 'incident' },
